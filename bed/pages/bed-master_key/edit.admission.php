...
$_SESSION['get-admiID'] = $admission_id;
?>
...
<head>
    <title>SFAC | Update Admission </title>
        ...
        <nav class="main-header navbar navbar-expand navbar-dark">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link disabled text-light">Update Admission</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    ...
                    <div class="container-fluid pl-5 pr-5 pb-3">
                        <div class="card card-purple shadow-lg">
                            <div class="card-header">
                                <h3 class="card-title">Admission Update Form</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <?php
                            $get_userInfo = mysqli_query($conn, "SELECT * FROM tbl_admissions WHERE admission_id = '$admission_id'");

                            while ($row = mysqli_fetch_array($get_userInfo)) { ?>
                            <form
                                action="userData/ctrl.edit.admission.php<?php echo '?admission_id=' . $admission_id; ?>"
                                    ...
                                    <div class="row mb-4 mt-5">
                                        <div class="input-group col-sm-4 mb-2">
                                            ...
                                            <input type="text" class="form-control" name="firstname"
                                                placeholder="First name" value="<?php echo $row['admission_fname']; ?>">
                                        </div>
                                        ...
                                        <div class="input-group col-sm-4 mb-2">
                                            ...
                                            <input type="text" class="form-control" name="lastname"
                                                placeholder="Last name" value="<?php echo $row['admission_lname']; ?>">
                                        </div>
                                        ...
                                        <div class="input-group col-sm-4 mb-2">
                                            ...
                                            <input type="text" class="form-control" name="midname"
                                                ...
                                                value="<?php echo $row['admission_mname']; ?>">
                                        </div>
                                    </div>
            ...
            // alert 
            if (isset($_SESSION['success-admiEdit'])) {
                echo "<script>
    $(function() {
...
title: 'Successfully Updated.'
            ...
            unset($_SESSION['success-admiEdit']);
