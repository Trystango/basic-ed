...
<head>
    <title>SFAC | Principal List</title>
        ...
        <nav class="main-header navbar navbar-expand navbar-dark">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link disabled text-light">Principals List</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                            ...
                            <div class="col-12">
                                <div class="card shadow">
                                    <div class="card-header bg-navy p-3">
                                        <h3 class="card-title text-lg">Principals List</h3>
                                    </div>
                                    <!-- /.card-header -->
                                    <div class="card-body">
                                        <table id="example2" class="table table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="edit.principal.php<?php echo '?prin_id=' . $id; ?>"
                                                            type="button"
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-footer">
                                                                        ...
                                                                        <a href="userData/ctrl.delPrin.php<?php echo '?prin_id=' . $id; ?>"
                                                                            type="button"
