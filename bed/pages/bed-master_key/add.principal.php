...
<head>
    <title>SFAC | Principal Sign up </title>
        ...
        <nav class="main-header navbar navbar-expand navbar-dark">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link disabled text-light">Add Principal</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                    ...
                    <div class="container-fluid pl-5 pr-5 pb-3">
                        <div class="card card-info shadow-lg">
                            <div class="card-header">
                                <h3 class="card-title">Principal Sign up Form</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form action="userData/ctrl.addPrin.php" enctype="multipart/form-data" method="POST">
                                <div class="card-body">
