...
<body class="hold-transition sidebar-mini layout-fixed">
    <div class="wrapper">
        ...
        <nav class="main-header navbar navbar-expand navbar-dark">
                ...
                <section class="content">
                    <div class="container-fluid pl-5 pr-5 pb-3">
                        <div class="card card-purple shadow-lg">
                            ...
                            <!-- form start -->
                            <?php
                            $get_userInfo = mysqli_query($conn, "SELECT * FROM tbl_principals WHERE prin_id = '$prin_id'");

                            while ($row = mysqli_fetch_array($get_userInfo)) { ?>
                            <form action="userData/ctrl.editPrin.php<?php echo '?prin_id=' . $prin_id; ?>"
                                    ...
                                    <div class="row mb-4 mt-5">
                                        <div class="input-group col-sm-4 mb-2">
                                            ...
                                            <input type="text" class="form-control" name="firstname"
                                                placeholder="First name" value="<?php echo $row['prin_fname']; ?>">
                                        </div>
                                        ...
                                        <div class="input-group col-sm-4 mb-2">
                                            ...
                                            <input type="text" class="form-control" name="lastname"
                                                placeholder="Last name" value="<?php echo $row['prin_lname']; ?>">
                                        </div>
                                        ...
                                        <div class="input-group col-sm-4 mb-2">
                                            ...
                                            <input type="text" class="form-control" name="midname"
                                                placeholder="Middle name" value="<?php echo $row['prin_mname']; ?>">
                                        </div>
                                    </div>
            ...
            // alert 
            if (isset($_SESSION['success-prinEdit'])) {
                echo "<script>
    $(function() {
