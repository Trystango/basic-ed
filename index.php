...
<head>
    ...
    <!-- Page Title -->
    <title>SFAC | Basic Education</title>

    <!-- Compressed Styles -->
    <link href="assets/css/slides.min.css?41331" rel="stylesheet" type="text/css">
    ...
    <!-- Compressed Scripts -->
    <script src="assets/js/slides.min.js?41331" type="text/javascript"></script>

    <!-- Custom Scripts -->
    <!-- <script src="js/custom.js" type="text/javascript"></script> -->

    <!-- Fonts and Material Icons -->
    <link rel="stylesheet" as="font" href="assets/css/fonts.mat.css" />
...
<body class="slides chain simplifiedMobile animated">
    ...
    <nav class="panel top">
        <div class="sections desktop">
            <div class="left"><a href="index.php" title="sfac"><img height="75" width="75" src="assets/img/logo.png"
                        alt="logo-left"></a></div>
            <div class="center">
            ...
            <div class="right">
                <ul class="menu trim">
                    ...
                    <li class="cropRight"><a href="#" class="trimRight" target="_blank"><svg>
        ...
        <div class="sections compact hidden">
            <div class="left"><a href="https://designmodo.com/?u=3165" title="Slides Framework"><svg
    ...
    <section class="slide fade-6 kenBurns">
        <div class="content">
            <div class="container">
                <div class="wrap">
                    ...
                    <div class="fix-12-12">
                        <div class="fix-4-12">
                            <p height="77" class="wide ae-1 fromCenter h2 bold">SAINT FRANCIS OF ASSISI COLLEGE
                            </p>
                        </div>
              ...
              <svg>
                <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#play"></use>
                        ...
                        <p class="ae-3"><span class="opacity-8">Enroll now | <b>Be one of us</b></span>
                        </p>
              ...
              <input type="password" class="input-9 ae-5 fromCenter" name="user-password" placeholder="Password"
                val="" />
              <input type="password" class="input-9 ae-6 fromCenter" name="confirm-password"
        ...
        <div class="background" style="background-image:url(assets/img/background/bg-1.jpg)"></div>
    </section>
                ...
                <div class="wrap">
                    ...
                    <div class="fix-12-12">
                        <div class="fix-8-12 left toRight">
                            <h1 class="ae-1">K to 12 CURRICULUM</h1>
                            <p class="ae-2 h4"><span class="opacity-8">

                                    The K-12 curriculum of Saint Francis of Assisi College is planned and implemented
                                    through the joint
                                    efforts of the teachers and the administration. It is organized with proper
                                    consideration of the
                                    students’ abilities and interests; their changing needs, and their expanding
                                    interests. Computer
                                    education, in all levels, is an integral part of the curriculum.

                                    The syllabi, lessons and examinations are carefully planned and constructed so that
                                    teachers and
                ...
                <div class="wrap">
                    ...
                    <div class="fix-12-12">
                        <div class="fix-6-12 left toLeft">
                            ...
                            <p class="ae-2"><span class="opacity-8">You must forget all your theories, all your ideas
                                    before the
                                    subject. What part of these is really your own will be expressed in
                                    your&nbsp;expression.</span></p>
                    ...
                    <div class="fix-12-12">
                        <ul class="flex left">
                            <li class="col-6-12 fromBottomLeft">
                                ...
                                <div class="ae-3">
                                    <p class="opacity-8">No matter how many times your amazing, absolutely brilliant
                                        work is rejected by
                                        the client, for whatever dopey, arbitrary reason, there is often another
                                        amazing, absolutely
                            ...
                            <li class="col-5-12 bottom">
                                <div class="videoThumbnail shadow rounded popupTrigger margin-bottom-3 ae-7"
                                    data-popup-id="89-3">
                        ...
                        <ul class="grid grid-85 equal margin-top-5 ae-2 fromCenter" data-equal-collapse-width="767">
                            <li class="col-6-12 col-tablet-1-2 col-phablet-1-1 margin-bottom-2 ae-3">
                                <div class="pad" style="background: #F5FBFE">
                                    ...
                                    <a href="#" class="button green gradient wide cropSides cropBottom ae-7">Try
                                        Free</a>
                                </div>
                            </li>
            ...
            <div class="container">
                <div class="wrap">
                    ...
                    <div class="fix-6-12">
                        ...
                        <p class="hero ae-2 margin-bottom-3"><span class="opacity-8">Learning never exhausts the
                                mind.</span></p>
